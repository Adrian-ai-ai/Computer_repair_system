    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit User: {{ $user->name }}</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Update user information and role</p>
                    </div>
